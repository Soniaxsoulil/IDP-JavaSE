...
public class Numbers {
    ...
    public static void main(String[] args) {
        ...
        int d = 321 + 12 / 78 * 3 - 1 ;
        System.out.println(d); // Le resultat 320
        
        
        d = (1 + 1) * 3;
        
        // Les calculs fonctionnent comme une calcultatrice, avc le même ordre de priorité
        ...
        d=10;
        System.out.println(d++); // 10 -> Affiche d puis incrémente d+1
         ...
         * 
         * Dans le cas contraire, il faudra caster explicitement, et on prend le risque de perdre en précision
         **
         */
